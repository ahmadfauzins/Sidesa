                    ...
                    <table class="table table-striped mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#" class="font-weight-600"><img src="<?php echo base_url('assets\assets_stisla\assets\imgavatar/avatar-1.png');?>" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                          </td>
                          <td>
