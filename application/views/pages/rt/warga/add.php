				...
				<div class="section-body">
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<form method="post" action="<?php echo site_url('rt/warga/insert') ?>" enctype="multipart/form-data">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-sm-12 col-md-3">
											<input type="number" class="form-control" name="rt" value="<?= $this->session->userdata('level') ?>" required readonly>
										</div>
