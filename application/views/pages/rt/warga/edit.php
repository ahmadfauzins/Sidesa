						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									...
									<form method="post" action="<?php echo site_url('rt/warga/update') ?>" enctype="multipart/form-data">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-sm-12 col-md-3">
											<input type="number" class="form-control" name="rt" required value="<?= $wrg->rt?>" readonly>
										</div>
											<label class="col-form-label col-md-1 col-lg-1 mt-auto">/ RW</label>
										<div class="col-sm-12 col-md-3">
											<input type="number" class="form-control" name="rw" required value="<?= $wrg->rw?>">
										</div>
									</div>
									<div class="form-group row mb-4">
